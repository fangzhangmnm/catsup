...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Hn,depthTest:!1,depthWrite:!1})}function S0(i,e,t){let n=new Float32Array(es),s=new L(0,1,0);return new $t({name:"SphericalGaussianBlur",defines:{n:es,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:yl(),fragmentShader:`
