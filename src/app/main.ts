...
for (const spec of TOOL_SPEC) {
  ...
  b.addEventListener("click", () => editor.setTool(spec.tool));
  toolbarEl.appendChild(b);
  toolBtns.set(spec.tool, b);
}
...
type MenuId = "export" | "import" | "finger" | "lab" | "clear" | "help" | "update";
